...
;; ## added by OPAM user-setup for emacs / tuareg ## c0c50f323560a3a229f8fa50500176e2 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/hugo/.opam/4.02.3/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
